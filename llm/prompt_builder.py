...
---------------------
Builds LLM prompts from cleaned processor output.
...
Supports all source types:
  ...
  - Image (OCR)          → ocr_text           ← was MISSING
...
_SOURCE_INSTRUCTIONS: dict[str, str] = {
    ...
    "github_repo":      "This is a GitHub project. Explain what it does and how it works.",
    "github_file":      "This is a code file. Explain its purpose and key logic.",
    "web":              "This is a web article. Extract the main ideas and insights.",
    ...
    "local_image":      "This is OCR-extracted text from an image or screenshot. "
...
- Ignore filler words, ads, and navigation text.
